...
namespace Modules\Components\Utility\DataTables\Category;

use Modules\Foundation\DataTables\BaseDataTable;
use Modules\Components\Utility\Models\Category\Category;
use Modules\Components\Utility\Transformers\Category\CategoryTransformer;
...
//        return $model->withCount('products');
    ...
    protected function getFilters()
    {
        return [
            ...
            'parent.id' => ['title' => trans('Utility::attributes.category.parent_id'), 'class' => 'col-md-2', 'type' => 'select', 'options' => \Category::getCategoriesList(), 'active' => true],
            'created_at' => ['title' => trans('Modules::attributes.created_at'), 'class' => 'col-md-2', 'type' => 'date', 'active' => true],
        ];
    }
}
