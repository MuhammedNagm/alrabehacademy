...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        ...
        (new \Modules\User\Communication\database\migrations\CreateNotificationTemplatesTable())->up();
        (new \Modules\User\Communication\database\migrations\CreateNotificationsTable())->up();
