...
try {
    $customFields = \Modules\Menu\Models\Menu::where('url', 'like', 'custom-fields')->first();

    if (!$customFields) {
        $administrationMenu = \Modules\Menu\Models\Menu::where('key', 'administration')->first();
        \Modules\Menu\Models\Menu::create([
    ...
    \Modules\User\Models\Permission::updateOrCreate(['name' => 'Settings::custom_field_setting.view'], [
        'guard_name' => config('auth.defaults.guard'),
        'created_at' => \Carbon\Carbon::now(),
        'updated_at' => \Carbon\Carbon::now(),
    ]);
    \Modules\User\Models\Permission::updateOrCreate(['name' => 'Settings::custom_field_setting.create'], [
        'guard_name' => config('auth.defaults.guard'),
        'created_at' => \Carbon\Carbon::now(),
        'updated_at' => \Carbon\Carbon::now(),
    ]);
    \Modules\User\Models\Permission::updateOrCreate(['name' => 'Settings::custom_field_setting.update'], [
        'guard_name' => config('auth.defaults.guard'),
        'created_at' => \Carbon\Carbon::now(),
        'updated_at' => \Carbon\Carbon::now(),
    ]);
    \Modules\User\Models\Permission::updateOrCreate(['name' => 'Settings::custom_field_setting.delete'], [
        'guard_name' => config('auth.defaults.guard'),
        'created_at' => \Carbon\Carbon::now(),
        'updated_at' => \Carbon\Carbon::now(),
    ]);
