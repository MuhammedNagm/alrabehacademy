...
@section('actions')
    {!! ModulesForm::link(url('http://laraship.com/contact/'),'Theme::labels.theme.theme_contact',['class'=>'btn btn-success','target'=>'_blank']) !!}
    {!! ModulesForm::link(url($resource_url.'/add'),'Theme::labels.theme.theme_add_new',['class'=>'btn btn-primary modal-load','data-title'=>trans('Theme::labels.theme.add_new_theme')]) !!}
    {!! ModulesForm::link(url($resource_url.'?check-for-updates=true'),'Theme::labels.theme.theme_check_update',['class'=>'btn btn-success']) !!}
@endsection
