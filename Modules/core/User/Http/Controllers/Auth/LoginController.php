...
class LoginController extends AuthBaseController
{
    ...
    */
    ...
    public function __construct()
    {
        ...
        $this->modules_middleware_except = ['logout'];
        parent::__construct();
    }
    ...
    public function redirectPath()
    {
        ...
        //         $redirect_to_default = $role->redirect_url;
        //     } elseif (!empty($role->dashboard_url)) {
        //         $redirect_to_default = $role->dashboard_url;
        //     }
        // }

        $redirect_to = \Filters::do_filter('auth_redirect_to', $redirect_to_default);
