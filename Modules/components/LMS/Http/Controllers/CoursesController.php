    ...
    public function update(CourseRequest $request, Course $course)
    {
        try {
           ...
           $request->merge($checks);
            ...
            Section::where('course_id', $course->id)->whereNotIn('id', $request->get('sections', []))->delete();
