...
class QuizQuestionsDataTable extends BaseDataTable
{
    ...
    public function query(Question $model)
    {
        ...
        // $getQuestions = $model->join('lms_quiz_questions','lms_questions.id','lms_quiz_questions.question_id')->where('lms_quiz_questions.quiz_id',$quiz->id)->orderBy('lms_quiz_questions.order','asc')->newQuery();
