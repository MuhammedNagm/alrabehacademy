	...
	<section class="page-content">
		<div class="container">
		    ...
		    <div class="message message-danger alert alert-danger" role="alert"role="alert">
					<i class="fa"></i> <p><strong>تنبيه!...</strong> الاشتراك بهذه الباقة غير مفعل ,لذلك لن تتمكن من عرض المحتوى بها الا بعد تفعيل الاشتراك. </p>
...
{{-- 							@if($planPrice > 0)
							...
							<button type="button"  data-toggle="modal" data-target="{{'#subPlan_'.$plan->hashed_id}}" class="colored-btn-red" @if($subscriptionStatus['success']) disabled='' style="background-color: #949596;" @endif >@lang('developnet-lms::labels.spans.span_subscribe_now')</button>
	                       ...
	                       {{--  <a href="javascript:;" class="colored-btn-red" style="background-color: #f8b032; ">@lang('developnet-lms::labels.spans.span_booked')</a> --}}
	                        ...
	                        <a href="{{route('plans.plan_content', ['plan' => $plan->hashed_id])}}" class="btn btn-danger"> محتوى الباقة </a>
	                        @endif
                                          ...
                                          @if($planCoursesCount)
							  				...
							  				<li class="duration-feature">
							  					<i class="fa fa-clock-o"></i>
							  					 ...
							  					 <span class="value">{{$plan->duration}} @if($plan->duration > 2 && $plan->duration < 11)@lang('LMS::attributes.main.minutes') @else @lang('LMS::attributes.main.minute')
					@endif</span>
							  				</li>
							  				@endif
{{--
							  				...
							  				<li class="assessments-feature">
							  					...
							  					@elseif($plan->sale_price == $plan->price || $plan->price < $plan->sale_price )
