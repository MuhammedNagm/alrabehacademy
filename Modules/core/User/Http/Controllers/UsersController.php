...
class UsersController extends BaseController
{
    protected $excludedRequestParams = [
        ...
        'password_confirmation', 'roles', 'clear', 'confirmed','departments'
    ];
    ...
    {
        $this->setViewSharedData(['title_singular' => trans('Modules::labels.show_title', ['title' => $user->name])]);
    ...
    {
        $this->setViewSharedData(['title_singular' => trans('Modules::labels.update_title', ['title' => $user->name])]);
    ...
    public function storeAddress(Request $request, User $user)
    {
        ...
        try {
            ...
            $message = [
                'level' => 'success', 'message' => trans('Modules::messages.success.saved', ['item' => trans('User::module.address.title')]),
    ...
    public function destroyAddress(Request $request, User $user, $type)
    {
        try {
            ...
            $message = [
                'level' => 'success', 'message' => trans('Modules::messages.success.deleted', ['item' => trans('User::module.address.title')]),
                'action' => 'refresh_address',
                'address_list' => $addressListForm
            ];
        } catch (\Exception $exception) {
