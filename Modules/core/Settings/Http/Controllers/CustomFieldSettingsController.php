...
use Modules\Settings\DataTables\CustomFieldsDataTable;
use Modules\Settings\Http\Requests\CustomFieldSettingRequest;
...
class CustomFieldSettingsController extends BaseController
{
    ...
    {
        $this->setViewSharedData(['title_singular' => trans('Modules::labels.update_title', ['title' => $customFieldSetting->name])]);
