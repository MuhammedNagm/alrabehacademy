...
<html data-theme='light' lang="{{ \Language::getCode() }}" dir="{{ \Language::getDirection() }}" translate="no">
@else
<html>
@endif
...
<head>
    ...
    <script defer src='https://static.cloudflareinsights.com/beacon.min.js' data-cf-beacon='{"token": "a7e19e259412427c9e62ade4ead19182"}'></script><!-- End Cloudflare Web Analytics -->
    @yield('css')
    @stack('child_css')
