<?php namespace Modules\Elfinder\Http\Controllers;

use Modules\Elfinder\Connector;
use Modules\Elfinder\Session\LaravelSession;
        ...
        if (empty($roots)) {
            ...
            foreach ($dirs as $dir) {
                ...
                $data = [
                    ...
                    'uploadAllow' => array('image/png', 'image/jpeg', 'image/gif', 'application/zip'),
