...
namespace Modules\Components\Utility\Http\Controllers\Category;

use Modules\Foundation\Http\Controllers\BaseController;
use Modules\Components\Utility\DataTables\Category\AttributesDataTable;
use Modules\Components\Utility\Http\Requests\Category\AttributeRequest;
...
class AttributesController extends BaseController
{
    ...
    {
        $this->setViewSharedData(['title_singular' => trans('Modules::labels.update_title', ['title' => $attribute->label])]);
