...
namespace Modules\Foundation\Traits\Language;

use Modules\Foundation\Models\Language\Translation;
...
trait Translatable
{
    ...
    public static function bootTranslatable()
    {
        static::saving(function ($item) {
            ...
            $languageCode = $item->translation_language_code;
            ...
            foreach ($item->getConfig('translatable') as $key) {
                $item->queuedTranslations[$languageCode][$key] = $item->attributes[$key];
