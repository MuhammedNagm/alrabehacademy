<li id="quizItemRow_{{$data->id}}" class="list-group-item  sortable ajax_submit_inputs parent_item_row" style="display: flex;align-items:  center;"> 
                   <i class="fa fa-arrows-alt  grabbing handle"></i>  <input class="form-control course_item_title" name="course_item_title" type="text" placeholder="add new quiz" style="margin: 0 10px;" value="{{$data->title}}">  
                   <input name="sectionItems[{{$section_id}}][]" type="hidden" value="quiz_{{$data->id}}">  
