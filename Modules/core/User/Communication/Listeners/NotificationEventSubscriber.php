...
namespace Modules\User\Communication\Listeners;
...
class NotificationEventSubscriber
{
    ...
    {
        $event = ModulesNotification::getEventByName($eventName);
    ...
    public function subscribe($events)
    {
        ...
        $events->listen('notifications.*',
            'Modules\User\Communication\Listeners\NotificationEventSubscriber@handleNotificationEvent'
        );
    }
}
