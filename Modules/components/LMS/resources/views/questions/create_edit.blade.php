...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($question, ['url' => url($resource_url.'/'.$question->hashed_id.'?paragraph='.\Request::get('paragraph')),'method'=>$question->exists?'PUT':'POST','files'=>true,'class'=>'ajax-form']) !!}
            <div class="row">
                <div class="col-md-8">
 ...
 {!! ModulesForm::text('title','LMS::attributes.main.title',true,$question->exists?$question->title:$question_title) !!}
                ...
                <div class="col-md-4">
                    ...
                    @endcomponent
                    @component('components.box')
                        {!! ModulesForm::select('quizzes[]','LMS::attributes.main.quizzes', \LMS::getAllQuizzesList(),false,null,['multiple'=>true], 'select2') !!}
