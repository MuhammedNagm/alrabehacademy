...
class QuizTransformer extends BaseTransformer
{
    ...
    {
        $show_url = url('/quizzes/' . $quiz->hashed_id.'/show');
        ...
        return [ 
            ...
            'title' => '<a target="_blank" href="' . $show_url . '">' . str_limit($quiz->title, 50).'</a>',
            // 'slug' => $quiz->slug,
            ...
            'clone_quiz'  => '<a class="btn btn-danger" href="'.url('lms/quizzes/'.$quiz->hashed_id.'/clone').'" ><i class="fa fa-clone"></i> نسخ</a>',
