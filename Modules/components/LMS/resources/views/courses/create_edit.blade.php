...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            @component('components.box')
            {!! ModulesForm::text('live_class_url','LMS::attributes.lessons.live_class_url',false,null) !!}
            {!! ModulesForm::radio('live_class_status','LMS::attributes.lessons.live_class_status',false, trans('LMS::attributes.main.status_options'),$course->live_class_status?$course->live_class_status:0) !!}
{{--             {!! ModulesForm::text('live_class_start_at','LMS::attributes.lessons.live_class_start_at',false,null,['class' => 'datetimepicker']) !!}
            {!! ModulesForm::text('live_class_end_at','LMS::attributes.lessons.live_class_end_at',false,null,['class' => 'datetimepicker']) !!} --}}
            @endcomponent
                @component('components.box')
            ...
            {!! ModulesForm::checkbox('clear', 'LMS::attributes.main.clear') !!}
               ...
               {{-- {!! ModulesForm::select('tags[]','LMS::attributes.main.tags', \LMS::getTagsList(),false,null,['class'=>'tags','multiple'=>true], 'select2') !!} --}}
                ...
                {!! ModulesForm::radio('show_in_plan','LMS::attributes.main.show_in_plan',false, trans('LMS::attributes.main.yes_no'),$course->exists?$course->show_in_plan:0, []) !!}
        ...
        <ul></ul>
            ...
            <div class="box-body">
              <div class="box-group" id="course-items-list-group">
                ...
                @foreach($course->sections()->where('parent_id', null)->orderBy('order', 'asc')->get() as $section)
                    ...
                    <div class="tab-pane active" id="settings_general">
                           <div>
                            ...
                            <div class="flex">
                                ...
                                {!! ModulesForm::number('retake_count','LMS::attributes.courses.retake_count',false,$course->exists?$course->retake_count: '100000',['min'=>0])!!}
                                <input type="hidden" name="max_students" value="100000">
