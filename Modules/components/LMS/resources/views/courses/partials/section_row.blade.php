        ...
        <div class="panel box box-success parent_section_row" id="sectionItemRow_{{$data->id}}" style="margin-bottom: 50px;">
   ...
   <div class="input-group ajax_submit_inputs" style="width: 100%">
                ...
                <span class="input-group-btn">
                 <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="javascript:;" class="add_section_item" data-section-id="{{$data->id}}" data-item-type="section">{{ __('LMS::attributes.courses.add_section')}}</a></li>
