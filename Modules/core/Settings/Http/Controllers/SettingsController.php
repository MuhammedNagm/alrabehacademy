...
use Modules\Foundation\Traits\FileUploadTrait;
use Modules\Settings\DataTables\SettingsDataTable;
...
class SettingsController extends BaseController
{
    ...
    public function create(SettingRequest $request)
    {
        ...
        $this->setViewSharedData(['title_singular' => trans('Modules::labels.create_setting', ['type' => $type, 'title_singular' => $this->title_singular])]);
    ...
    {
        $this->setViewSharedData(['title_singular' => trans('Modules::labels.show_title', ['title' => $setting->label])]);
    ...
    public function edit(SettingRequest $request, Setting $setting)
    {
        ...
        $this->setViewSharedData(['title_singular' => trans('Modules::labels.update_title', ['title' => $setting->label])]);
    ...
    public function update(SettingRequest $request, Setting $setting)
    {
        try {
            ...
            $message = [
                ...
                'level' => 'success', 'message' => trans('Modules::messages.success.updated', ['item' => $this->title_singular])
            ];
        } catch (\Exception $exception) {
