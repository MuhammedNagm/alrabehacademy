...
class LmsTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($this->module_prefix . 'categories', function (Blueprint $table) {
            ...
            $table->boolean('show_in_plan')->nullable()->default(false); //only show as item at packages/plans not outside it
        ...
        Schema::create($this->module_prefix . 'courses', function (Blueprint $table) {
            ...
            $table->timestamp('live_class_end_at')->nullable();
            $table->timestamp('live_class_start_at')->nullable();
            $table->tinyInteger('live_class_status')->default(0);
        ...
        Schema::create($this->module_prefix . 'sections', function (Blueprint $table) {
            ...
            $table->foreign('parent_id')->references('id')->on($this->module_prefix . 'sections')->onDelete('cascade')->onUpdate('cascade');
        ...
        Schema::create($this->module_prefix . 'quizzes', function (Blueprint $table) {
            ...
            $table->boolean('sub_quiz_random')->default(false);
            ...
            $table->boolean('is_sub_quiz')->nullable()->default(false);
            ...
            $table->tinyInteger('numbers_in_arabic')->nullable()->default(0);
            $table->text('options')->nullable(); //json for more settings
            $table->unsignedInteger('certificate_id')->nullable(); //certificate template id
            $table->foreign('certificate_id')->references('id')->on($this->module_prefix . 'certificate_templates')->onDelete('cascade')->onUpdate('cascade');
            $table->unsignedInteger('author_id')->nullable();
            ...
            $table->softDeletes();
            $table->timestamps();
            $table->foreign('parent_id')->references('id')->on($this->module_prefix . 'quizzes')->onUpdate('cascade')->onDelete('cascade');
            ...
            $table->tinyInteger('status')->default(0);
            $table->dateTime('published_at')->nullable();
             $table->boolean('show_lesson_intro')->nullable()->default(false);
            $table->boolean('private')->default(false);
        ...
        Schema::create($this->module_prefix . 'questions', function (Blueprint $table) {
            ...
            $table->foreign('parent_id')->references('id')->on($this->module_prefix . 'questions')->onUpdate('cascade')->onDelete('cascade');
        ...
        Schema::create($this->module_prefix . 'sectionables', function (Blueprint $table) {
         ...
         Schema::create($this->module_prefix . 'lessons_parts', function (Blueprint $table) {
            ...
            // $table->string('sub_type')->nullable(); //vedio - text
            ...
            $table->text('meta_description')->nullable();
            $table->longText('content')->nullable();
            $table->string('embeded_source')->nullable();
            $table->string('embeded_type')->nullable();
        ...
        Schema::create($this->module_prefix . 'logs', function (Blueprint $table) {
            ...
            $table->integer('children_number')->nullable(); //ex: quiz have 10 questions since user last logged
        ...
        Schema::create($this->module_prefix . 'embeded_media', function (Blueprint $table) {
            ...
            $table->text('file_url');
            $table->string('source')->nullable(); //youtube ??
            $table->boolean('preview')->default(false);
            $table->boolean('status')->default(true);
            $table->unsignedInteger('created_by')->nullable()->index();
            $table->unsignedInteger('updated_by')->nullable()->index();
