...
namespace Modules\Components\Utility\Http\Controllers\Address;

use Modules\Foundation\Http\Controllers\BaseController;
use Modules\Components\Utility\DataTables\Address\LocationsDataTable;
use Modules\Components\Utility\Http\Requests\Address\LocationRequest;
use Modules\Components\Utility\Models\Address\Location;
...
class LocationsController extends BaseController
{
    ...
    {
        $this->setViewSharedData(['title_singular' => trans('Modules::labels.update_title', ['title' => $location->name])]);
