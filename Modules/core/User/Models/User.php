...
class User extends Authenticatable implements HasMediaConversions, TwoFactorAuthenticatableContract
{
    ...
    public function getPictureAttribute()
    {
        ...
        if ($media) {
            ...
            $gender = $this->attributes['gender'] ?? 'male';
            $avatar = 'default_avatar_' . $gender . '.png';
    ...
    {
        return $this->morphToMany(\Modules\Components\LMS\Models\Category::class, 'lms_categoriable');
