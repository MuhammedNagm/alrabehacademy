...
return [
    ...
    'models' => [
        'setting' => [
            'presenter' => \Modules\Settings\Transformers\SettingPresenter::class,
        ...
        'module' => [
            ...
            'paths' => [
                ...
                'core' => 'Modules/core',
                'payment' => 'Modules/componentsPayment',
            ]
        ],
        'custom_field_setting' => [
            'resource_url' => 'custom-fields',
            'presenter' => \Modules\Settings\Transformers\CustomFieldSettingPresenter::class,
            'supported_types' => [
