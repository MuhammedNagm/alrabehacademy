...
namespace Modules\Components\CMS\Traits;

use Modules\Components\CMS\Facades\CMS;
use Modules\Components\CMS\Http\Requests\PageRequest;
...
trait CMSControllerFunctions
{
 ...
 $template = $item->template ?: 'full';
    ...
    public function show(Request $request, $slug = '')
    {
        ...
        return view($view)->with(compact('item', 'featured_image', 'blog', 'home', 'page_title'));
    }
    ...
    public function blog(Request $request)
    {
        ...
        return view($view)->with(compact('blog', 'posts', 'title', 'featured_image', 'page_title'));
    }
