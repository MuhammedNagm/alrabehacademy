...
{{--         <button type="button" class="btn btn-success btn-sm" id="add-value" data-input="checkbox" style="display:none">
        ...
        <br>
        <div class="col-md-6">
          {!! ModulesForm::select('parent_id','LMS::attributes.questions.parent_paragraph',\LMS::getQuestionsParagraphsList(),false,$question->exists?$question->parent_id:hashids_decode(\Request::get('paragraph')), [], 'select2') !!}
