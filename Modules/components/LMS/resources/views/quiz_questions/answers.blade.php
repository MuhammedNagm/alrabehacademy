...
<div class="row question-type-div" @if($question->question_type != 'paragraph') style="display: none" @endif>
    <div class="col-md-12">
        ...
        <br>
        <br>
        {!! ModulesForm::select('parent_id','LMS::attributes.questions.parent_paragraph',\LMS::getQuestionsParagraphsList(),false,$question->exists?$question->parent_id:hashids_decode(\Request::get('paragraph'))) !!}
