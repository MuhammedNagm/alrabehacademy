...
namespace Modules\Components\Utility\Http\Controllers\Gallery;
...
class GalleryController extends BaseController
{
    ...
    public function galleryItemDelete(Request $request, $media)
    {
        try {
            ...
            $message = ['level' => 'success', 'message' => trans('Modules::messages.success.deleted', ['item' => trans('Utility::module.gallery.media.title')])];
        } catch (\Exception $exception) {
            $message = ['level' => 'error', 'message' => $exception->getMessage()];
    ...
    public function galleryItemFeatured(Request $request, $media)
    {
        try {
            ...
            $message = ['level' => 'success', 'message' => trans('Modules::messages.success.saved', ['item' => trans('Utility::module.gallery.media.title')])];
        } catch (\Exception $exception) {
            $message = ['level' => 'error', 'message' => $exception->getMessage()];
            log_exception($exception, Media::class, 'destroy');
        }
