...
<div class="quiz-questions">
	...
	<ul class="quiz-questions-list">
		<li class="singl-question">
			...
			<div class="radio" @if(in_array($answer->hashed_id, $userWrongAnswers))style="background-color: red !important; color: #fff;" @elseif(in_array($answer->hashed_id, $correctAnswersArray)) style="background-color: green; color: #fff;"@endif>
			...
			@else
			<div class="checkbox" @if(in_array($answer->hashed_id, $userWrongAnswers))style="background-color: red !important; color: #fff;" @elseif(in_array($answer->hashed_id, $correctAnswersArray)) style="background-color: green; color: #fff;"@endif>
