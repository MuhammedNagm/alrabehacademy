...
use Modules\Components\LMS\Transformers\ParagraphQuestionTransformer;
use Yajra\DataTables\EloquentDataTable;

class ParagraphQuestionsDataTable extends BaseDataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->setTransformer(new ParagraphQuestionTransformer());
    }
