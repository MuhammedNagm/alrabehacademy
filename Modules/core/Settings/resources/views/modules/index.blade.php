...
@section('actions')
    {!! ModulesForm::link(url($resource_url.'/rescan'),'Settings::labels.module.rescan',['class'=>'btn btn-warning']) !!}
    {!! ModulesForm::link(url($resource_url.'/add'),'Settings::labels.module.add_new',['class'=>'btn btn-primary modal-load','data-title'=>"Add New Module"]) !!}
    {!! ModulesForm::link(url($resource_url.'?check-for-updates=true'),'Settings::labels.module.check_update',['class'=>'btn btn-success']) !!}
@endsection
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th>@lang('Modules::labels.action')</th>
                        </tr>
                        </thead>
                        <tbody>
