...
function profile($user_hashed_id){
       ...
       if(!$userBase)
        ...
        $subscriptions = $userLMS->subscriptions()->whereNotIn('id', \Subscriptions::expiredSubscriptions($userLMS))->get();
//        dd($subscriptions, \Subscriptions::expiredSubscriptions($userLMS));
        $hasSubscriptions = $subscriptions->count()?true:false;
