...
class RolesController extends BaseController
{
    ...
    {
        $this->setViewSharedData(['title_singular' => trans('Modules::labels.update_title', ['title' => $role->label])]);
    ...
    public function destroy(RoleRequest $request, Role $role)
    {
        try {
            ...
            if ($role->id == $super_user_role) {
                throw new \Exception(trans('User::exception.invalid_destroy_roles'));
            }
