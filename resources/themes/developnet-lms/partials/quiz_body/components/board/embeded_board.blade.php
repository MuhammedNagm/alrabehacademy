...
<input type="color" class="select-bg-color" value="#848484">
...
<button type="button" class="btn btn-light"  class="open-full" id="openFullscreen"><i class="fa fa-arrows-h"></i> تكبير </button>
...
@section('js')
<script src="https://cdnjs.cloudflare.com/ajax/libs/screenfull.js/4.2.1/screenfull.min.js" integrity="sha256-C7pjusD5f5nCGja5jSe2cGhmIlv7oII22lRbWSdVOL4=" crossorigin="anonymous"></script>
...
zwibbler.setConfig("background", '#848484');
  $(".select-bg-color").on('change', function() {
    var inpt = $(this);
    zwibbler.setConfig("background", inpt.val());
