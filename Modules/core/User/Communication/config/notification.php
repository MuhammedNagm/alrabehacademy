...
return [
    'models' => [
        'notification_template' => [
            'presenter' => \Modules\User\Communication\Transformers\NotificationTemplatePresenter::class,
            'resource_url' => 'notification-templates'
        ],
        'notification' => [
            'presenter' => \Modules\User\Communication\Transformers\NotificationPresenter::class,
