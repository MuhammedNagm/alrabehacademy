...
namespace Modules\Components\Utility\Http\Controllers\Wishlist;

use Modules\Foundation\Http\Controllers\BaseController;
use Modules\Components\Utility\Classes\Wishlist\WishlistManager;
...
class WishlistBaseController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->modules_middleware_except = array_merge($this->modules_middleware_except, ['setWishlist']);
