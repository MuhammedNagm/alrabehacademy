...
use Modules\Theme\Providers\ThemeRouteServiceProvider;
...
class ThemeServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('modules.themes', function () {
            return new Themes();
        });
    ...
    public function boot()
    {
        ...
        $themes = $this->app->make('modules.themes');
        $themes->scanThemes();
        ...
        $this->commands([
            \Modules\Theme\Commands\listThemes::class,
            \Modules\Theme\Commands\createTheme::class,
            \Modules\Theme\Commands\removeTheme::class,
            \Modules\Theme\Commands\createPackage::class,
            \Modules\Theme\Commands\installPackage::class,
            \Modules\Theme\Commands\refreshCache::class,
        ]);
        ...
        $this->loadTranslationsFrom(__DIR__ . '/resources/lang', 'Theme');
            ...
            $adminTheme = \Theme::find(\Settings::get('active_admin_theme', config('themes.modules_admin')));
            $this->loadThemeTranslations($adminTheme);

            $frontEndTheme = \Theme::find(\Settings::get('active_frontend_theme', config('themes.modules_frontend')));
