...
<div class="p-course-item">
	<div class="media course-item-content">
		...
		<div class="media-body row">
			<div class="row">
				<div class="">
					<div><a href="{{ route('courses.show', $course->hashed_id) }}">{{$course->title}}</a></div>
					<div>
		...
		<ul>
			...
			<li>
				...
				<small>
					...
					{{$course->duration}} @if($course->duration > 2 && $course->duration < 11)@lang('LMS::attributes.main.'.$course->duration_unit.'s') @else @lang('LMS::attributes.main.'.$course->duration_unit)
					@endif
