...
use Modules\Foundation\Search\IndexedRecord;

/**
 * Class Indexable
 *
 * @package Modules\Foundation\SearchServiceProvider
 */
trait Indexable
{
    ...
    {
        return $this->morphOne('Modules\Foundation\Search\IndexedRecord', 'indexable');
    }
