...
@section('css')
    {!! \Html::style('assets/modules/plugins/nestable/nestable.css') !!}
    {!! \Html::style('assets/modules/plugins/fontawesome-iconpicker/css/fontawesome-iconpicker.min.css') !!}
@endsection
    ...
    <div class="row">
        <div class="col-md-6">
            @component('components.box')
                @include('components.nav_pills',['pills'=>\Modules\Menu\Facades\Menus::getParents($root->key)])
...
@section('js')
    {!! \Html::script('assets/modules/plugins/nestable/jquery.nestable.js') !!}
    {!! \Html::script('assets/modules/plugins/fontawesome-iconpicker/js/fontawesome-iconpicker.min.js') !!}
