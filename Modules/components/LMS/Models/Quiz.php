  ...
  public function plans()
    {
      ...
      public function hint_videos()
    {
        return $this->morphMany(EmbededMedia::class, 'mediable');
    }
...
public function coupons()
    {
        return $this->morphToMany(\Modules\Components\LMS\Models\Coupon::class, 'lms_couponable');
    }
