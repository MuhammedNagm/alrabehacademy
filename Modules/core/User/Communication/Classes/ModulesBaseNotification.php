...
namespace Modules\User\Communication\Classes;
...
abstract class ModulesBaseNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function getNotificationAttributes($notifiable, $channel)
    {
        ...
        try {
            ...
            log_exception($exception, ModulesBaseNotification::class, 'getNotificationAttributes');
        }
